...
class AbstractLevel(yaml.YAMLObject):
    ...
    def from_yaml(cls, loader, node):
        # обработчик создания отчета !easy_level
        def get_easy_level(loader, node):
            data = loader.construct_mapping(node)
            print(data)

        # обработчик создания отчета !medium_level
        def get_medium_level(loader, node):
            data = loader.construct_mapping(node)
            print(data)

        # обработчик создания отчета !hard_level
        ...
        # возвращаем результат yaml обработчика - levels
